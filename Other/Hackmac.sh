...
defaults write com.apple.universalaccess reduceTransparency -bool fal

# Set highlight color to green
defaults write NSGlobalDomain AppleHighlightColor -string "0.764700 1 0.999"
...
defaults write com.apple.screencapture location -string "${HOME}/Documents/ScreenshortFiles"
